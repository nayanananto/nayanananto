...
## [My GitHub Repositories](https://github.com/nayanananto?tab=repositories) &nbsp;·&nbsp; [LeetCode](https://leetcode.com/u/Amortal) &nbsp;·&nbsp; [LinkedIn](https://linkedin.com/in/ananto-nayan) &nbsp;·&nbsp; [Technical Writing](https://anayan.pythonanywhere.com/)
...
**Adversarial Forecasting with LSTM vs GAN-LSTM** &nbsp;·&nbsp; [GitHub](https://github.com/nayanananto/Adversarial-Forecasting-with-LSTM-vs-GAN-LSTM)
...
**Customer Segmentation using PySpark** &nbsp;·&nbsp; [GitHub](https://github.com/nayanananto/Customer-Segmentation-using-PySpark)
...
**Diabetes Prediction — Decision Tree vs KNN** &nbsp;·&nbsp; [GitHub](https://github.com/nayanananto/Diabetes-Prediction)
...
**Phishing Website Detection** &nbsp;·&nbsp; [GitHub](https://github.com/nayanananto/java-weka-phishing-detection)
